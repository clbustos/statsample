module Statsample
  ...
  class StratifiedSample
    ...
    #class singleton methods end above.
    ...
    def standard_error_wor_2(field)
      sum = @ms.sum_field(field)  do |s_name, vector|
    ...
    def variance_pst(field, v = 1)
      sum=@ms.datasets.inject(0) do |a, da|
        stratum_name = da[0]
        ds = da[1]
        nh = ds.cases.to_f
